	    ...
	    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception 
	    {
			return http.csrf(AbstractHttpConfigurer::disable)
	                .authorizeHttpRequests(request ->
	                        ...
	                        .requestMatchers("/api/products/admin/**").hasAuthority(UserRole.ADMIN.name())
	                        .requestMatchers("/api/products/user/**").hasAnyAuthority(UserRole.USER.name(), UserRole.ADMIN.name())
